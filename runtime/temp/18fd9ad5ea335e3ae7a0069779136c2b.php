<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"F:\workplace\mc/application/admin\view\login.html";i:1510190602;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="signinpanel">
    <div class="row">
        <div class="col-sm-7" style="color:#fff">
            <div class="signin-info">
                    ...
                    <div class="m-b"></div>
                    <h4>OuTeng Web Content Management Center.</h4>
                    <ul class="m-b">
        ...
        <div class="col-sm-5" style="color:#fff">
            <form id="doLogin" name="doLogin" method="post" action="<?php echo url('doLogin'); ?>">
                ...
                <p class="m-t-md">Powered by OUTENG.NET V3.1</p>
    ...
    <div class="signup-footer">
        <div class="pull-left">
            <a href="http://www.outeng.net/"  target="_blank"  style="color:#fff">&copy; OUTENG.NET  V3.1</a>
        </div>
    </div>
</div>
...
<script src="__JS__/otcms.js"></script>
 <script>
    ...
    $.ajax({
        ...
        url: "<?php echo url('Otadmins/Login/getVerify',array('t'=>time())); ?>", // 加随机数防止缓存
        type: "get",
        dataType: "json",
