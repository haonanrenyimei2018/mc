<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:51:"E:\workplace\mc/application/admin\view\ad\edit.html";i:1531297514;s:57:"E:\workplace\mc/application/admin\view\public\header.html";i:1525915507;s:57:"E:\workplace\mc/application/admin\view\public\footer.html";i:1525915507;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="add" id="add" method="post" action="edit">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input type="number" name="months" id="months" class="form-control" value="<?php echo $data['months']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
