<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"E:\workplace\mc/application/admin\view\role\index.html";i:1525915507;s:57:"E:\workplace\mc/application/admin\view\public\header.html";i:1525915507;s:57:"E:\workplace\mc/application/admin\view\public\footer.html";i:1525915507;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    //删除角色
    function roleDel(id){
        otcms.confirm(id,'<?php echo url('roleDel'); ?>');
    }

    //角色状态
    function role_state(id){
        otcms.status(id,'<?php echo url("role_state"); ?>');
    }
