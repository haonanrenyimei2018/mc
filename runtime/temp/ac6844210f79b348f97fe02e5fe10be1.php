<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:49:"E:\workplace\mc/application/admin\view\index.html";i:1525442391;s:57:"E:\workplace\mc/application/admin\view\public\header.html";i:1508205842;s:57:"E:\workplace\mc/application/admin\view\public\footer.html";i:1508205842;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div id="wrapper">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li><a href="<?php echo url('personal/index'); ?>" class="J_menuItem">我的资料</a></li>
                            <li><a href="<?php echo url('otadmins/login/loginOut'); ?>">安全退出</a></li>
                        </ul>
                    </div>
                    <div class="logo-element">OT<sup> +</sup>
                    </div>
                </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right"><a href="http://www.outeng.net/"  target="_blank" style="color:#999">&copy; OUTENG.NET  V3.1</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
...
$(function(){
    $("#cache").click(function(){
        layer.confirm('你确定要清除缓存吗？', {icon: 3, title:'提示'}, function(index){                   
            $.getJSON("<?php echo url('otadmins/index/clear'); ?>",function(res){
                if(res.code == 1){
