<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"E:\workplace\mc/application/admin\view\member\index.html";i:1531838496;s:57:"E:\workplace\mc/application/admin\view\public\header.html";i:1531230408;s:57:"E:\workplace\mc/application/admin\view\public\footer.html";i:1531230408;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="example">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr class="long-tr">
                            ...
                            <th style="text-align: left;">到期时间</th>
                        ...
                        <script id="list-template" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td style="text-align: left;">{{d[i].date_end}}</td>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:;" onclick="resetPwd({{d[i].id}})" class="btn btn-primary btn-xs">
                                        <i class="fa fa-paste"></i>重置密码</a>&nbsp;&nbsp;
...
<script>
    ...
    function resetPwd(id){
        ...
        layer.confirm('确定要执行此操作吗？', {icon: 3, title:'提示'}, function(index){
            $.getJSON('resetpwd.html', data, function(res){
                if(res.code == 1){
