<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"E:\workplace\mc/application/admin\view\menu\edit_rule.html";i:1525915507;s:57:"E:\workplace\mc/application/admin\view\public\header.html";i:1525915507;s:57:"E:\workplace\mc/application/admin\view\public\footer.html";i:1525915507;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal m-t" name="edit_rule" id="edit_rule" method="post" action="<?php echo url('edit_rule'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                ...
                                <span class="help-block m-b-none">如：otadmins/user/adduser </span>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
