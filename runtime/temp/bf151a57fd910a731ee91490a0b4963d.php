<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"F:\workplace\mc/application/admin\view\member\check.html";i:1526650844;s:57:"F:\workplace\mc/application/admin\view\public\header.html";i:1508205842;s:57:"F:\workplace\mc/application/admin\view\public\footer.html";i:1508205842;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="add" id="add" method="post" action="check.html">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <span class="form-control"><?php echo $member['phone']; ?></span>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <span class="form-control"><?php echo $member['idn']; ?></span>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <span class="form-control"><?php echo $member['wechat']; ?></span>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label" style="text-align: right">是否有推荐人</label>
                            <div class="input-group col-sm-4">
                                <input type="checkbox" class="js-switch" name="is_pid" id="is_pid" checked value="1">
                            </div>
                        </div>
                        <div id="pid_div">
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" style="text-align: right">选择推荐人</label>
                                <div class="input-group col-sm-4">
                                    <select name="pid" id="pid" class="form-control">
                                        <option value="0">--请选择--</option>
                                        <?php if(is_array($members) || $members instanceof \think\Collection || $members instanceof \think\Paginator): if( count($members)==0 ) : echo "" ;else: foreach($members as $key=>$val): ?>
